#ifndef ALGINE_SHADERPROGRAMMANAGERLEGACY_H
#define ALGINE_SHADERPROGRAMMANAGERLEGACY_H
...
class ShaderProgramManagerLegacy: public Transferable {
public:
    enum {
        RemoveFirst,
        RemoveLast,
...
#endif //ALGINE_SHADERPROGRAMMANAGERLEGACY_H
